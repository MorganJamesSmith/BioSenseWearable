Several challenges were faced during the course of this project in regards to both the
...
%should we get rid of the \ref? -> yes - Kira
...
In the end, a solution was found; when Bluetooth is 
